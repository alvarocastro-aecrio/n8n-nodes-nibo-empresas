...
**Teste de instalação real (regra 7)**, na instância limpa, com a 0.4.0 instalada pela tela
Community Nodes, **contra a empresa cobaia**:
...
| ☐ | A cobaia termina o aceite com **zero registros** |
