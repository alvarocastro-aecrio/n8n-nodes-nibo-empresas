...
export const file: Translations = {
	...
	"file.operation.upload": {
		name: "Enviar",
		description: "Armazena um documento na Nibo e recebe o ID de volta, sem anexá-lo a nada ainda",
	...
	"file.uploadNotice": {
		displayName: "Quem tiver o ID de um arquivo armazenado aqui consegue baixar o documento sem token: o link que a Nibo publica para ele é público. Não envie nada que não possa ser lido por quem tiver o link.",
	},
	"file.binaryProperty": {
	...
	"file.scheduleId": {
		...
		description: "A conta em que o documento entra, a receber ou a pagar tanto faz — esta API tem uma única rota para as duas, e é a de contas a receber. O node consulta a Nibo sobre esta conta antes de enviar qualquer coisa: uma conta que não existe é aceita ao anexar sem dizer uma palavra, e o documento ficaria no armazenamento, onde nenhuma rota desta API consegue encontrá-lo de novo.",
	...
	"file.fileName": {
		...
		description: "Como o documento é chamado: o nome sob o qual a Nibo o arquiva ao enviar, e o nome que o campo binário recebe ao baixar. Deixado em branco, é usado o nome que o arquivo já carrega.",
